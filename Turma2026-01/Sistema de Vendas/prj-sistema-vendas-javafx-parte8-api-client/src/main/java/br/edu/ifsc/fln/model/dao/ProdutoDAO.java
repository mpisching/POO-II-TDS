...
public class ProdutoDAO{
    ...
    public List<Produto> listarProdutoEstoque() throws DAOException {
        String sql =  "SELECT * FROM produto p INNER JOIN estoque e ON p.id = e.id_produto;";
        List<Produto> retorno = new ArrayList<>();
        try {
            PreparedStatement stmt = connection.prepareStatement(sql);
            ResultSet resultado = stmt.executeQuery();
    ...
    private Produto populateFullVO(ResultSet rs) throws SQLException, DAOException {
