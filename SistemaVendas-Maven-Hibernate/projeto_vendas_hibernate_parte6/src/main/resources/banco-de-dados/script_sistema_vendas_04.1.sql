CREATE DATABASE IF NOT EXISTS db_vendas4_1;
USE db_vendas4_1;

/*tabela de configuração do sistema - com propósito de substituir o atributo static empresa em Venda*/
CREATE TABLE configuracao (
                              id INT AUTO_INCREMENT PRIMARY KEY,
                              nome_empresa VARCHAR(100) NOT NULL
);

INSERT INTO configuracao (nome_empresa) VALUES ('Organizações IFSC - Floripa');
...
CREATE TABLE venda(
   ...
   /*empresa varchar(50) NOT NULL,
     atributo excluído por tratar de um dado estático na classe de domínio. Não é persistido
     como unidade persistente com hibernate. Adotar outras estratégias, como table de configuraçao se
     desejar armazenar o valor estático para não ficar hardcoded*/
...
INSERT INTO venda(data, total, pago, taxa_desconto, situacao, id_cliente) VALUES('2022-09-29', '5000.00', false, '0.00', 'FINALIZADA', '1');
...
INSERT INTO venda(data, total, pago, taxa_desconto, situacao, id_cliente) VALUES('2022-10-30', '1300.50', true, '0.00',  'FINALIZADA', '2');
...
/*USE db_vendas4;
ALTER TABLE venda DROP COLUMN empresa;*/