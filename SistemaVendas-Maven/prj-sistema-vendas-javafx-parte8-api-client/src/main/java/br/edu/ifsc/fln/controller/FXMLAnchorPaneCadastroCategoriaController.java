    ...
    public void handleBtInserir() throws IOException {
        ...
        if (btConfirmarClicked) {
            try {
                ...
                HttpClientCategoriaUtil.createCategoria(categoria);
                carregarTableViewCategoria();
        ...
        if (categoria != null) {
            ...
            if (btConfirmarClicked) {
                try {
                    ...
                    HttpClientCategoriaUtil.updateCategoria(categoria.getId(), categoria);
                    carregarTableViewCategoria();
                } catch (IOException ex) {
                    AlertDialog.exceptionMessage(ex);
                }
    ...
    public void handleBtExcluir() throws IOException {
        ...
        if (categoria != null) {
            try {
                ...
                HttpClientCategoriaUtil.deleteCategoria(categoria.getId());
                carregarTableViewCategoria();
            } catch (IOException ex) {
                AlertDialog.exceptionMessage(ex);
            }
